  ...
  return (
    <>
      <div className="animate-fadeAndSlideUp mt-16 flex max-w-5xl flex-col gap-16 max-lg:mt-4">
        <div className="animate-fadeAndSlideUp mt-6 flex items-start gap-12 max-md:flex-col">
          <FirstSession />
          <div className="">
            <Image
              width={425}
              ...
              src={MyProfile}
              className="rounded-2xl shadow-2xl shadow-white/5 transition-all delay-75 duration-500 ease-in-out lg:hover:scale-110"
            />
          </div>
        </div>
        <ProjectSession />
